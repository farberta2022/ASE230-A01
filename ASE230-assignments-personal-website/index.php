  ...
  <!-- Section Heading-->
    ...
    <!-- Single Advisor-->
      <div class="col-12 col-sm-6 col-lg-3">
        ...
        <!-- Team Thumb-->
          <div class="advisor_thumb"><a href="TAMI_FARBER.php"><img src="https://www.bootdey.com/img/Content/avatar/avatar3.png" alt="Woman with ponytail"></a>
          <!-- Social Info-->
            <div class="social-info"><a href="TAMI_FARBER.php"><i class="fa fa-facebook"></i></a><a href="TAMI_FARBER.php"><i class="fa fa-twitter"></i></a><a href="TAMI_FARBER.php"><i class="fa fa-linkedin"></i></a></div>
          </div>
        <!-- Team Details-->
          <div class="single_advisor_details_info">
            <h6><?php echo "Tami Farber"; ?></h6>
            <p class="designation"><?php echo "Sustainability Officer"; ?></p>
          </div>
        </div>
      </div>
  <!-- Single Advisor-->
